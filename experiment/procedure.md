...
8. The water flows at a steady rate. Various values such as the time taken, starting head, and the final head are recorded as is visible from the table. The procedure is repeated for different starting head values. Finally, the permeability is computed for each of the different trials using the formula mentioned in the theory.
